...
* Train models using the training dataset and test their performance on unseen data.
...
Using separate training and testing datasets helps evaluate how well the models generalize to **unseen data**.
...
## 🔧 Feature Engineering
New features were created to explore different relationships between the variables:
* `bedrooms_squared`
* `bed_bath_rooms`
* `log_sqft_living`
* `lat_plus_long`
...
The models are compared based on their prediction errors on the **testing dataset**.
